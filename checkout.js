...
if (typeof JSON !== "object") {
    ...
    // f(n) zero-pad single digit
    function f(n) {
        return n < 10 ? "0" + n : n
    }

    // make sure `Date.prototype.toJSON` is a function
...
(function() {
    var 
        ...
        namespace = "StripeCheckout.require".split("."),
        // = require
    ...
    //  i = 0: base & base['StripeCheckout'] = {}
    //  i = 1: base 
    for (i = 0; i < namespace.length - 2; i++) {
        base = base[namespace[i]] = base[namespace[i]] || {}
    }
    // incase require doesn't exists, we make our own require function
    // TODO: study how `require` function works
    if (base[name] === undefined) {
        base[name] = function() {
            ...
            // define function accepts object
